...
export const returnHttpErrorsAsJSON = (err: any, req: express.Request, res: express.Response, next: express.NextFunction) => {
    if (err instanceof HttpError) {
        ...
        if(process.env.NODE_ENV === "production" && !process.env.SHOW_STACK_TRACES) {
